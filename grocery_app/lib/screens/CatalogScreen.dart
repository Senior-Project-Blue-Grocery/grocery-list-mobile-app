        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            ...
            children: [
              ...
              _SectionHeader(title: "Shop by Aisle", onTap: () {}),
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return _CategoryChip(
                      ...
                      onTap: () {
                        setState(() {
                          _searchQuery = c.label.toLowerCase();
                        });
                      },
                    );
                  },
              ...
              _SectionHeader(title: "New Products for you", onTap: () {}),
              const SizedBox(height: 10),
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, i) =>
                      _ProductCard(item: newProducts[i]),
                ),
              ),

              const SizedBox(height: 24),
              _SectionHeader(title: "Poultry", onTap: () {}),
              const SizedBox(height: 10),
